...
<p>
            ...
            Admin Panel using credentials which are sent to the registered mail
            ID. .
            <br /> <br />
            Step 3. Then in Packages {">"} Settings, the manager assigns the
            parcel configuration and zone settings.
            <br /> <br /> Step 4 Then in Riders, the Manager can add new riders
            for delivery by verifying their profile and the manager can also
            update/delete the existing riders.
            ...
            and verify it by scanning the barcode in the packages using our own
          ...
          <p>
            ...
            credentials.
            <br /> <br />
            Step 3: Then Rider selects the vehicle type EV or FUEL. If a company
            EV vehicle, rider can scan the QR code in the allocated EV
            <br /> <br />
            ...
            <br /> <br /> Step 8: In Support Centre screen, Rider can contact or
            chat with hub manager.
          </p>
